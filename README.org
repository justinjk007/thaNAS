...
#+begin_src sh
ansible-playbook setup_thaNAS_playbook.yml --list-tasks --vault-pass-file ansible_vault_password.txt
ansible-playbook setup_thaNAS_playbook.yml -u root --vault-pass-file ansible_vault_password.txt # execute
#+end_src
