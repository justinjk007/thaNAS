...
file:ansible_vault.yml --> Put token here

#+begin_src yml
DROPBOX_ACCESS_TOKEN: ssasasatoken
#+end_src

** Execute the playbook

#+begin_src sh
ansible-playbook setup_thaNAS_playbook.yml -i ansible_hosts.conf -u root --vault-pass-file ansible_vault_password.txt
#+end_src
